...
public class mainDriver extends Application {
	...
	private WeightedGraph<Integer> getGraph() {
		...
		int[][] edgess =     {{0, 1, 2}, {0, 3, 8}, 
			      ...
			      {4, 2, 5}, {4, 3, 6}};
		WeightedGraph<Integer> graph1 = new WeightedGraph<>(vertice, edgess);
	...
	public void start(Stage stage) throws Exception {
		...
		allSPButton.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				//get user values
				Integer value1 = Integer.valueOf(startVertexTxt.getText());
				Integer value2 = Integer.valueOf(endVertexTxt.getText());
		...
		mstButton.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				...
				WeightedGraph thisGraph = getGraph();
				//if there are at least 2 vertices
